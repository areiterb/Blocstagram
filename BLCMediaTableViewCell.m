...
- (void) layoutSubviews {
    ...
    NSLog(@"self.commentLabel.frame: %@",NSStringFromCGRect(self.commentLabel.frame));
...
// No idea why it has this errors?  Not sure if change of xCode 6 causes this to guide of Bloc
